...
const Packet = React.forwardRef(({ children, ipHeader }, ref) => {
  ...
  return (
    <div ref={ref} className="relative mt-4">
      <div ref={ipLabelRef} className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-2 bg-blue-500 text-white text-xs font-bold rounded">IP</div>
      <div ref={selfRef} className="p-2 border-2 border-blue-500 bg-gray-800 rounded-lg flex flex-col gap-2">
        ...
        <div ref={ipHeaderRef} className="text-xs font-mono bg-gray-900 p-1 rounded flex justify-between">
